...
from Variaveis import URL_GNRE_LOTE, EVENTO_GNRE, URL_GNRE_CONSULTA
...
xml_retornado_lote = Envia_Requisicao('EMPRESA1',URL_GNRE_LOTE["producao"],xml_completo_lote,EVENTO_GNRE["processar"])
...
if recibo:
    # Exemplo de uso
    corpo_xml_consulta = Estrutura_XML_CONSULTA_GNRE.Corpo_XML_GNRE(ambiente='1', numero_recibo=recibo, incluir_pdf_guias='S', incluir_arquivo_pagamento='N', incluir_noticias='N')    
    ...
    # Necessário informar a 'EMPRESA' e o ambiente, pode ser 'producao' ou 'homologacao'
    xml_retornado_consulta = Envia_Requisicao('EMPRESA1',URL_GNRE_CONSULTA["producao"],xml_completo_consulta,EVENTO_GNRE["consultar"])
